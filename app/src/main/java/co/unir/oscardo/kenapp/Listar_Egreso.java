...
public class Listar_Egreso extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_listar__egreso);
    }

    public void ListarEgresos(View v){
        ...
        ArrayList<Clase_Egreso> CE = new ArrayList<>();
        CE = BD.Consulta_Egreso(0, mes, Integer.valueOf(annio), 0);
        if(!CE.isEmpty()) {
            for (Clase_Egreso i :
                    CE) {
